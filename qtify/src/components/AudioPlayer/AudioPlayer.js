...
function AudioPlayer({ song, album = "Album Name" }) {
  ...
  let songDef = {
    image: require("../../assets/CardImageBollySongs.png"),
    title: "Song Name",
  };
  ...
  // function songSetSliderPosition() {
  //   sliderSong.current.max = Math.floor(metaDataDuration);
  // }
    ...
    <div className={styles.player_container}>
      <div className={styles.song_image_name}>
        <img
          ...
          src={songDef.image || require("../../assets/CardImageBollySongs.png")}
